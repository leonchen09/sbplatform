...
public class AppConfigVo {
	...
	@Pattern(regexp = "^0|(-?[1-9]\\d*)|(-?(0|[1-9]\\d*)\\.\\d+)$" , message ="电压最大值设置参数非法！")
	private String maxGenVol;
	
	@Pattern(regexp = "^0|(-?[1-9]\\d*)|(-?(0|[1-9]\\d*)\\.\\d+)$" , message ="电压最小值设置参数非法！")
	private String minGenVol;
	
	@Pattern(regexp = "^0|(-?[1-9]\\d*)|(-?(0|[1-9]\\d*)\\.\\d+)$" , message ="电流最大值设置参数非法！")
	private String maxGenCur;
	
	@Pattern(regexp = "^0|(-?[1-9]\\d*)|(-?(0|[1-9]\\d*)\\.\\d+)$" , message ="电流最小值设置参数非法！")
	...
	@Pattern(regexp = "^0|(-?[1-9]\\d*)|(-?(0|[1-9]\\d*)\\.\\d+)$" , message ="单体电压最大值设置参数非法！")
	private String maxCellVol;
	
	@Pattern(regexp = "^0|(-?[1-9]\\d*)|(-?(0|[1-9]\\d*)\\.\\d+)$" , message ="单体电压最小值设置参数非法！")
	...
	@Pattern(regexp = "^0|([0-9]{1,3})|1000$" , message ="内阻参数设置必须是0-1000的整数！")
