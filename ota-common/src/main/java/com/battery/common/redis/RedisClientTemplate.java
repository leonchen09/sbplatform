...
@Repository
@ConditionalOnBean(value= {ShardedJedisPool.class,RedisDataSource.class})
@AutoConfigureAfter(value= {ShardedJedisPool.class,RedisDataSource.class})
